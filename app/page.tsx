...
import { clinicStats } from "@/lib/data/testimonials";
  ...
  return (
    <>
      {/* ══════════════════════════════════════════
          HERO SECTION
      ══════════════════════════════════════════ */}
      <section className="flex items-center pt-xl pb-xl px-md md:px-lg max-w-container-max mx-auto w-full relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-xl w-full z-10 items-center">
          ...
          <div className="lg:col-span-6 flex flex-col items-start gap-md">
            ...
            <div className="mt-lg backdrop-blur-xl bg-white/60 border border-outline-variant/30 rounded-xl p-sm pr-md shadow-soft flex items-center gap-sm border-l-4 border-l-secondary hover:bg-white/80 transition-all w-full max-w-full">
              ...
              <div className="min-w-0">
                ...
                <p className="font-body-md text-body-md text-on-surface font-medium break-words">
          ...
          <div className="lg:col-span-6 relative flex justify-center lg:justify-end w-full">
            ...
            {/* Hero image */}
            <div className="relative z-10 w-full max-w-[480px] aspect-[4/3] rounded-[2rem] overflow-hidden border-[6px] border-white shadow-2xl shadow-primary-container/20 self-center animate-float">
              <Image
            ...
            <div className="absolute z-20 bottom-4 left-0 sm:left-4 backdrop-blur-xl bg-white/80 border border-outline-variant/30 rounded-xl p-sm shadow-xl flex items-center gap-sm animate-float-delayed">
              ...
              <div className="pr-xs">
                <p className="font-headline-sm text-[18px] font-bold text-on-background leading-tight">2</p>
                <p className="font-body-sm text-body-sm text-on-surface-variant leading-tight text-xs">Specialist Doctors</p>
              </div>
            </div>

            {/* Floating Badge 2 — Services */}
            <div className="absolute z-20 top-4 right-0 sm:-right-4 backdrop-blur-xl bg-white/80 border border-outline-variant/30 rounded-xl p-sm shadow-xl flex items-center gap-sm animate-float">
              <div className="w-10 h-10 rounded-full bg-secondary-container flex items-center justify-center flex-shrink-0">
                <span className="material-symbols-outlined text-on-secondary-container text-[20px]">medical_services</span>
              </div>
              <div className="pr-xs">
                <p className="font-headline-sm text-[16px] font-bold text-on-background leading-tight">9+</p>
                <p className="font-body-sm text-body-sm text-on-surface-variant leading-tight text-xs">Services Available</p>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* ══════════════════════════════════════════
          STATS BAR
      ══════════════════════════════════════════ */}
      <div className="w-full bg-surface-container-low border-y border-outline-variant/30 py-lg overflow-hidden">
        <div className="max-w-container-max mx-auto px-md md:px-lg grid grid-cols-2 md:grid-cols-4 gap-y-md md:gap-y-0 divide-x-0 md:divide-x divide-outline-variant/30">
          {clinicStats.map((stat) => (
            <div key={stat.label} className="flex flex-col items-center text-center px-xs sm:px-sm">
              <span className="font-headline-md text-headline-md text-primary mb-xs">{stat.value}</span>
              <span className="font-label-technical text-label-technical text-on-surface-variant uppercase tracking-wider text-center">
                {stat.label}
              </span>
            </div>
          ))}
      ...
      ══════════════════════════════════════════ */}
      <section className="py-xl px-md md:px-lg max-w-container-max mx-auto w-full">
        <div className="bg-surface-container rounded-[2rem] p-md sm:p-lg md:p-xl grid grid-cols-1 lg:grid-cols-2 gap-xl items-center shadow-sm border border-outline-variant/20">
            ...
            <ul className="flex flex-col gap-sm">
              {[
                ...
                >
                  ...
                  <span className="font-headline-sm text-[18px] sm:text-[20px] text-on-background">{item.label}</span>
                </li>
              ))}
            </ul>
          </div>

          <div className="relative rounded-[2rem] overflow-hidden border-[6px] border-white shadow-xl aspect-square order-1 lg:order-2 w-full max-w-[480px] mx-auto lg:mx-0">
            <Image
      ...
      <section className="py-xl px-md md:px-lg max-w-container-max mx-auto w-full mb-xl">
        <div className="bg-secondary rounded-3xl p-md sm:p-lg md:p-xl text-center shadow-xl">
          <div className="max-w-3xl mx-auto flex flex-col items-center">
            ...
            <div className="flex flex-col sm:flex-row gap-md justify-center items-center w-full">
              <Link
                href="/appointment"
                className="bg-white text-secondary font-button text-button px-lg py-sm rounded-full hover:bg-secondary-fixed transition-colors shadow-md w-full sm:w-auto sm:min-w-[200px] text-center"
              >
                Book Online Now
              </Link>
              <Link
                href="/contact"
                className="border-2 border-white text-white font-button text-button px-lg py-sm rounded-full hover:bg-white/10 transition-colors w-full sm:w-auto sm:min-w-[200px] text-center"
              >
                Contact Our Clinic
              </Link>
            </div>
