    ...
    <>
      ...
      <div className="w-full">
        ...
        <header className="flex items-center justify-between mb-8">
          <h2 className="text-3xl font-bold text-slate-900 px-2" style={{ fontFamily: "'Playfair Display', serif" }}>
            Referrals
          </h2>
            <Link
              href="/admin"
              className="flex items-center justify-center gap- px-2 py-2.5 text-sm font-semibold text-white rounded-xl shadow-sm hover:shadow-md hover:-translate-y-0.5 active:scale-95 transition-all duration-200"
              style={{ background: "linear-gradient(90deg, #1b4f8a 0%, #0E4D4D 100%)" }}
            >
          ...
          <button
            ...
            className="flex items-center gap- px-4 py-2.5 text-sm font-semibold text-white rounded-full shadow-md hover:shadow-lg hover:-translate-y-0.5 active:scale-95 transition-all duration-200"
